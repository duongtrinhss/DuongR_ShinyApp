...
# This version: 27 July 2022
# Input: "/Users/duongtrinh/Dropbox/FIELDS/Data Science/R_Data Science/R Practice/Nsim500nsave2000nburn100_2707/resFiTab.rds"
# Outputs:
# =====================================================================================
# setwd("/Users/duongtrinh/Dropbox/FIELDS/Data Science/R_Data Science/R Practice/DuongR_ShinyApp/KST-ana3")
library(shiny)
library(ggplot2)
library(tidyverse)
library(DT)
